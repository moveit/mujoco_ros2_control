...
def generate_launch_description():
    ...
    controller_config_file = os.path.join(mujoco_ros2_control_demos_path, 'config', 'cartpole_controller_velocity.yaml')
    ...
    node_mujoco_ros2_control = Node(
        ...
        parameters=[
            ...
            {'mujoco_model_path':os.path.join(mujoco_ros2_control_demos_path, 'mujoco_models', 'test_vertical_cart_velocity.xml')}
        ]
    )
